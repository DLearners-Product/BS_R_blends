 ...
 /*   public void SynthesizeButtonOnClickHandler()
    {
        ...
        if (EventSystem.current.currentSelectedGameObject.transform.parent.GetComponent<Text>() != null)
        {
            content = EventSystem.current.currentSelectedGameObject.transform.parent.GetComponent<Text>().text;
           // Debug.Log("TEXT : " + content);
        }
        if (EventSystem.current.currentSelectedGameObject.transform.parent.GetComponent<TextMeshProUGUI>() != null)
        {
            if(EventSystem.current.currentSelectedGameObject.transform.parent.GetComponent<clickText>()!=null)
            {
                content = EventSystem.current.currentSelectedGameObject.transform.parent.GetComponent<clickText>().STR_Original;
            }else
            {
                content = EventSystem.current.currentSelectedGameObject.transform.parent.GetComponent<TextMeshProUGUI>().text;
            }
            ...
            while (content.Contains("<"))
            {
               ...
               // Debug.Log("Unwanted" + unwantedString);
    ...
    public void BUT_draw()
    {
        ...
        if (I_drawcount % 2 != 0)
        {
            ...
            {
                G_currenlevel.GetComponent<Draw>().BUT_erase();
